export default {
  translations: {
    ...
    'custom-colors': {
      ...
      description:
        'Busque um produto, selecione as variantes sem cor nativa e associe cada nome a um hexadecimal para que a vitrine renderize as bolinhas corretamente.',
      products: {
        title: 'Produtos',
      ...
      editor: {
        'empty-title': 'Selecione um produto',
        empty: 'Escolha um produto na lista para editar seus mapeamentos de cor.',
        helper:
          'As variantes abaixo usam o nome cadastrado no produto. O salvamento é por nome da variante.',
        'show-native': 'Mostrar variantes com cor nativa',
        'hide-native': 'Ocultar variantes com cor nativa',
        'native-color': 'Cor nativa',
        'no-variants': 'Nenhuma variante disponível para edição.',
        save: 'Salvar alterações',
        unsaved: 'Não salvo',
        'search-variant': 'Buscar variação',
        'save-success': 'Alterações salvas com sucesso',
