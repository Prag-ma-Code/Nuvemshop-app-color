...
The storefront integration script is served from `public/script_tag.js` and expects an `api_base` query parameter so it can read the public backend route for custom colors.
```
